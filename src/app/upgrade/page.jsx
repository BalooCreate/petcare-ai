...
import { ArrowLeft, Check, Star, Camera, Zap, ShieldCheck, Activity } from "lucide-react";

export default function UpgradePage() {
  
  const handleUpgrade = (plan) => {
    // Aici vom pune logica de Stripe mai târziu
    alert(`Redirecting to secure payment... \nYou will start a 14-day FREE trial for the ${plan} plan. \nYour card will not be charged today.`);
  };
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 font-sans">
      ...
      <div className="max-w-4xl mx-auto text-center mb-12">
        ...
        <p className="text-gray-500 max-w-xl mx-auto">
          Unlock Smart Scan & AI features. <br/>
          <span className="font-bold text-gray-900">Start with a 14-day free trial. Cancel anytime.</span>
        </p>
      </div>
