    ...
    <div className="min-h-screen bg-white font-sans text-gray-800">
      ...
      <div className="text-center pt-14 pb-20 px-6 bg-gradient-to-b from-white via-[#F1FFF6]/50 to-[#F1FFF6]">
        <div className="inline-flex items-center gap-2 bg-white border border-green-200 text-green-700 px-4 py-1.5 rounded-full text-xs font-bold shadow-sm mb-6">
          <Gift size={14} /> <span>100% free to start • No credit card needed</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3">
          <Link to="/signup?plan=free" className="bg-green-600 text-white px-8 py-4 rounded-2xl font-bold text-[17px] hover:bg-green-700 transition shadow-xl shadow-green-200 transform hover:-translate-y-0.5 flex items-center justify-center gap-2">
            <PawPrint size={20} /> Start Free Now
          </Link>
          <Link to="/chat" className="bg-white text-gray-700 border border-gray-200 px-8 py-4 rounded-2xl font-bold text-[17px] hover:bg-gray-50 transition flex items-center justify-center gap-2">
            <MessageCircle size={20} /> Try the AI
          </Link>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            <div className="bg-[#F1FFF6] p-6 rounded-[1.5rem] border border-green-100 hover:shadow-lg transition group">
              ...
              <p className="text-sm text-gray-500 mt-1">Food, walks, vaccines — you never miss a thing.</p>
              <span className="text-[11px] font-bold text-green-600 mt-3 inline-block bg-green-100 px-2 py-1 rounded-full">FREE</span>
            </div>
            ...
            <div className="bg-purple-50 p-6 rounded-[1.5rem] border border-purple-100 hover:shadow-lg transition group">
              ...
              <h3 className="font-bold text-gray-900">Health Journal</h3>
              <p className="text-sm text-gray-500 mt-1">Weight, symptoms, medication — all organized.</p>
              <span className="text-[11px] font-bold text-purple-600 mt-3 inline-block bg-purple-100 px-2 py-1 rounded-full">FREE</span>
            </div>
            <div className="bg-orange-50 p-6 rounded-[1.5rem] border border-orange-100 hover:shadow-lg transition group">
              ...
              <p className="text-sm text-gray-500 mt-1">Scan food, toys and medication with AI.</p>
              <span className="text-[11px] font-bold text-orange-600 mt-3 inline-block bg-orange-100 px-2 py-1 rounded-full">3 FREE / MONTH</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-green-600 text-white px-4 py-1 rounded-full text-xs font-bold uppercase tracking-wider mb-4">
              <Gift size={12} /> Freemium model — pay only if you want more
            </div>
          ...
          <div className="text-center mt-8">
            <Link to="/pricing" className="text-sm font-bold text-gray-600 hover:text-green-600 underline">See full comparison →</Link>
          </div>
        </div>
      </div>
      ...
      <div className="py-20 px-6 bg-white">
        <div className="max-w-5xl mx-auto text-center mb-14">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">How it works — 20 seconds.</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="text-center">
            ...
            <h3 className="font-bold text-lg mb-1">Create a free account</h3>
            <p className="text-sm text-gray-500">Email + password, no card. 10 seconds.</p>
          </div>
          <div className="text-center">
            ...
            <h3 className="font-bold text-lg mb-1">Add your pet</h3>
            <p className="text-sm text-gray-500">Name, breed, age — profile done.</p>
          </div>
          <div className="text-center">
            ...
            <h3 className="font-bold text-lg mb-1">Get AI help</h3>
            <p className="text-sm text-gray-500">Ask anything, scan food, set reminders.</p>
          </div>
        </div>
      </div>
      ...
      <div className="py-24 px-6 bg-green-600 text-white text-center relative overflow-hidden">
        ...
        <div className="relative">
          <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider mb-6">
            <Sparkles size={14} /> No card • No risk • Free forever
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3">
            <Link to="/signup?plan=free" className="bg-white text-green-700 px-8 py-4 rounded-2xl font-bold text-lg shadow-xl hover:bg-green-50 transition flex items-center justify-center gap-2">
              <Gift size={20} /> Start Free — 20 sec
            </Link>
          ...
          <p className="text-green-200 text-xs mt-6">✓ No credit card for Free • ✓ Encrypted data • ✓ 30-day guarantee on Lifetime</p>
        </div>
      </div>
      ...
      <div className="bg-gray-900 py-10 text-center text-gray-400">
        ...
        <p className="text-xs">Your AI companion for better pet care • Free Forever, upgrade optional</p>
        ...
        <p className="text-[11px] mt-6 text-gray-500">© 2026 PetAssistant. Made with ♥ for pets.</p>
      </div>
    </div>
  );
}
